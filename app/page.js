        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto text-center">
            <div className="flex flex-col items-center justify-center space-y-2">
              <div className="flex items-center justify-center"> <NumberTicker value={52} className="text-4xl font-bold text-white"/> <span className="text-4xl">+</span></div>
              <p className="text-muted-foreground">Industries Covered</p>
            </div>
            <div className="flex flex-col items-center justify-center space-y-2">
              <div className="flex items-center justify-center"> <NumberTicker value={1000} className="text-4xl font-bold text-white"/> <span className="text-4xl">+</span></div>
              <p className="text-muted-foreground">Interview Questions</p>
            </div>
            <div className="flex flex-col items-center justify-center space-y-2">
             <div className="flex items-center justify-center"> <NumberTicker value={95} className="text-4xl font-bold text-white"/> <span className="text-4xl">%</span></div>
